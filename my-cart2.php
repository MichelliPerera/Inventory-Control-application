...
if(isset($_POST['remove_code'])) {
    if(!empty($_SESSION['cart'])){
        ...
        // Display alert indicating cart has been updated
        echo "<script>alert('Your Cart has been Updated');</script>";
    }
}
// Code for inserting product in order table
...
<div class="col-md-4 col-sm-12 estimate-ship-tax">
    <table class="table table-bordered">
        ...
        <tbody>
            <tr>
                <td>
                    <form method="post" action="checkout.php"> <!-- Replace 'checkout.php' with the appropriate action page -->
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control unicase-form-control text-input" name="address" required></textarea>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label class="info-title" for="phone1">Contact Number 1 <span>*</span></label>
                            <input type="tel" class="form-control unicase-form-control text-input" id="phone1" name="phone1" required>
                        </div>
                        <div class="form-group">
                            <label class="info-title" for="phone2">Contact Number 2</label>
                            <input type="tel" class="form-control unicase-form-control text-input" id="phone2" name="phone2">
                        </div>
                        <button type="submit" name="confirm_details" class="btn-upper btn btn-primary checkout-page-button">Confirm Details</button>
                    </form>
                </td>
            </tr>
        </tbody>
